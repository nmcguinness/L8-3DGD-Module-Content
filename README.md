...
| 4 | `atmosphere_and_feedback` | **Atmosphere and Feedback** — Niagara VFX as a design tool, Blueprint-driven light state transitions, non-UI feedback design, and colour grading with LUTs (including GIMP workflow) | [Atmosphere and Feedback](Notes/atmosphere_and_feedback.md) |
